...
try:
    # قراءة الملف مع دعم الحروف العربية (utf-8) لتجنب أخطاء الـ parse
    with open("final_products.json", "r", encoding="utf-8") as f:
        data = json.load(f)
        
    # استخراج المنتجات من الترتيب الجديد اللي سويناه
    ...
    if len(products) > 0:
        ...
        for item in products:
            ...
            # سحب السعر الأصلي وإضافة الربح (مثلاً ضفت 5000 دينار كربح، تگدر تغيرها)
